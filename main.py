"""
Script to get the list of current instnse in EC2 with tag filter.
"""
...
if __name__ == "__main__":
    ...
    id = getInstaceWithTag(tag="Name", value="poc*", region_name="us-west-1")
    logger.debug(
        f"{len(id)} instance deleted Successfully ✅"
    ) if terminateInstance(id) else logger.warning(
